...
class SpinSystem() :
    ...
    def build_hamiltonian(self,J_couplings: list,NN_vectors: list,max_NN_shell: int,shell_digits: int,B_field: 'np.ndarray',n_dim: int,tol_imag: float) -> 'np.ndarray' :
        '''
    ...
    def compute_spin_correlation(self,states: 'np.ndarray',GS_deg: int,first: int,second: int) -> 'np.ndarray' :
        '''
    ...
    def compute_all_spin_correlations(self,states: 'np.ndarray',GS_deg: int) -> tuple :
        '''
